...
@section('content')
        ...
        <div class="col">
            <div class="bg-body rounded-4 p-4 shadow-sm">
                <div class="d-flex align-items-center justify-content-between">
                    <div>
                        <h5 class="text-secondary mb-0">Descripción</h5>
                        <h2 class="mb-0">{{ $categoria->descripcion }}</h2>
                    </div>
                    <div class="fs-3">
    ...
    <div class="modal fade" id="editModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        ...
        <div class="modal-dialog">
            <form action="{{ route('categorias.update', $categoria) }}" method="POST" class="modal-content">
                @csrf
                @method('PUT')
                ...
                <div class="modal-body bg-body-secondary">
                    <label for="descripcion" class="text-secondary fs-5 ms-1">Descripción</label>
    ...
    <div class="modal fade" id="deleteModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        aria-labelledby="editModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <form action="{{ route('categorias.destroy', $categoria) }}" method="POST" class="modal-content">
                @csrf
                @method('DELETE')
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <h5 class="fw-normal">¿Seguro que deseas eliminar la categoria <b>{{ $categoria->descripcion }}</b>?</h5>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary me-auto" data-bs-dismiss="modal">Cerrar</button>
